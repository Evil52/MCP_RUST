...
pub struct Tool {
    ...
    /// Authentication policies supported by this tool.
    ///
    /// Local compatibility extension for OpenAI plugin clients. JSON objects
    /// are intentionally preserved so future scheme types remain forwards
    /// compatible while SEP-1488 is still evolving.
    #[serde(
        rename = "securitySchemes",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub security_schemes: Option<Vec<JsonObject>>,
...
impl Tool {
    ...
    /// Set the authentication policies advertised for this tool.
    pub fn with_security_schemes(mut self, security_schemes: Vec<JsonObject>) -> Self {
